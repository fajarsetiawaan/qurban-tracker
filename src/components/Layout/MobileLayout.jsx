...
export default function MobileLayout() {
    return (
        ...
        <div className="h-[100dvh] bg-slate-50 dark:bg-slate-950 lg:bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] lg:from-slate-50 lg:via-gray-100 lg:to-slate-200 dark:lg:from-slate-900 dark:lg:via-slate-900 dark:lg:to-slate-950 lg:flex lg:items-center lg:justify-center lg:py-8 font-sans text-slate-900 dark:text-slate-100 overflow-hidden relative selection:bg-emerald-200 dark:selection:bg-emerald-900">
            ...
            <div className="w-full max-w-md mx-auto bg-slate-50 dark:bg-slate-950 h-full lg:h-[850px] lg:rounded-3xl shadow-2xl overflow-hidden relative flex flex-col transform-gpu ring-1 ring-slate-900/5 dark:ring-slate-100/10">
